...
[https://pi-cai.grand-challenge.org](https://pi-cai.grand-challenge.org/)
CC-BY-NC 4.0. Masks from picai_labels.
...
Full project code, results, and write-ups (GitHub):
https://github.com/akulabalakrishna/picai-grounded-clinical-reasoning
- Results summary (all three directions): https://github.com/akulabalakrishna/picai-grounded-clinical-reasoning/blob/main/results_summary.md
- Data-quality findings (the defect-rate note below): https://github.com/akulabalakrishna/picai-grounded-clinical-reasoning/blob/main/findings.md
...
does in the training script -- see picai_geom.py, included in this package.
Canonical maintained copy:
https://github.com/akulabalakrishna/picai-grounded-clinical-reasoning/blob/main/scripts/picai_geom.py
gland and lesion already share t2w's exact
...
See findings.md, included in this package, or the canonical copy at
https://github.com/akulabalakrishna/picai-grounded-clinical-reasoning/blob/main/findings.md
for the full write-up of this defect rate as evidence for Direction D
